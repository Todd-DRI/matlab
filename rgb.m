% my_colors  returns color vector for my preferred color schemes and symbolse
%
%   BACKGROUND
%     This script is based on http://blogs.nature.com/nautilus/2007/02/post_4.htmlpublic domain and may be distributed freely.
