...
i=1;
 ...
 if varargin{1}==1
     ...
     text(60,-5,'Sand [%]','FontSize',14)

     p1=fill([100 85 95 100],[0 0 10 0],[1 1 1]);%[0.3 0.3 0.3]) TGC edited fill colors to all white
     text(97,3, 'Sand','color','k','FontSize',8)
     
     p2= fill([85 70 92.4 95 85],[0 0 15 10 0],[1 1 1]);%'y')
     text(92,7,{'Loamy';'  sand'},'FontSize',8)
     
     p3=fill([70 50 46.7 55 62 90 92.4 70],[0 0 7 7 20 20 15 0],[1 1 1]);%[0.6 0.3 0])
     text(84,14,'Sandy loam','FontSize',8)    
     
     p4=fill([55 46.7 38 58.1 62 55],[7 7 27 27 20 7],'w');%,[0 0.7 0])
     text(55,18,'Loam','FontSize',8)
         
     p5=fill([50 20 13.5 6 13.2 38 50],[0 0 12 12 27 27 0],'w');%,[0.5 0.5 0])
     text(35, 14, 'Silt loam','FontSize',8)
     
     p6=fill([20 0 6 13.5 20],[0 0 12 12 0],'w');%[0.3 0.6 0])
     text(12,5,'Silt','FontSize',8)
     
     p7=fill([90 62 58.1 62.5 82.5 90],[20 20 27 35 35 20],'w');%[0.9 0.3 0.1])
     text(82,27,{'Sandy clay';'     loam'},'FontSize',8)

     p8=fill([58.1 33 40 65 58],[27 27 40 40 27],'w');%[0 0.3 0.8])
     text(57,34,'Clay loam','Color','k','FontSize',8)

     p9=fill([33 13.5 20 40 33],[27 27 40 40 27],'w');%[0.8 0.8 0.8])
     text(33,33,{'Silty';' clay loam'},'FontSize',8)
     
     p10=fill([82.5 62.5 72.5 82.5],[35 35 55 35],'w');
     text(77,42,{'Sandy';' clay'},'Color','k','FontSize',8)
     
     p11=fill([65 40 30 50 72.5 65],[40 40 60 100 55 40],'w');%[1 0.8 0.2])
     text(55,60,'Clay','FontSize',8)
     
     p12=fill([40 20 30 40],[40 40 60 40],'w');%[0.2 0.2 0.2])
     text(33,46,{'Silty'; 'clay'},'Color','k','FontSize',8)
     axis square
     axis off
     ...
     for i=1:length(sand)
         ...
         plot(sand(i)*100+o/2,clay(i)*100,'ok','MarkerFaceColor','b')
     end
 end
